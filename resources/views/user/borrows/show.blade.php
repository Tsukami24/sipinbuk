...
@section('content')
    <div class="container py-4">
        ...
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-header text-white fw-bold" style="background:#0B132B;">
            ...
            <div class="card-body p-4">
                    ...
                    @foreach ($borrow->details as $detail)
                        <div class="col-12">
                            ...
                            <div class="d-flex align-items-center gap-3 p-3 border rounded-4 shadow-sm book-item">
                                ...
                                {{-- COVER --}}
                                <img src="{{ asset('storage/' . $detail->bookItem->book->cover) }}" class="rounded-3"
                                ...
                                <div>
                                    ...
                                    @if ($borrow->status === 'active' && !$detail->returned_at && !$detail->return_requested)
                ...
                @if ($totalFine > 0)
                    <div class="alert mt-4 border-0 rounded-4 text-white" style="background:#E63946;">
